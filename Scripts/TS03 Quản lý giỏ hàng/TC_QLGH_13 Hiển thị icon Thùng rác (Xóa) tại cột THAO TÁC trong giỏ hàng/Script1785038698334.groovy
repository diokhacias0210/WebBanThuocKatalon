...
WebUI.rightClick(findTestObject('Page_PharmaCare  Gi hng ca bn/input_selectAll'))

WebUI.assertElementPresent(findTestObject('Page_PharmaCare  Gi hng ca bn/input_selectAll'), 0)
