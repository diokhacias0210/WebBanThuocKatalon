...
WebUI.click(findTestObject('Page_Danh sch sn phm thuc  PharmaCare/img_Thuc Cardioton Lipa Pharma'))

WebUI.click(findTestObject('Page_Thuc Cardioton Lipa Pharma  PharmaCare/button_Thm vo gi hng'))

WebUI.rightClick(findTestObject('Page_Thuc Cardioton Lipa Pharma  PharmaCare/a_Gi hng'))

WebUI.assertElementText(findTestObject('Page_Thuc Cardioton Lipa Pharma  PharmaCare/a_Gi hng'), '\n                    \n                        \n                        3\n                    \n                ', 
    0)
